        ...
        for item in agnd:
            with st.container(border=True):
                ...
                with c2:
                    ...
                    msg = urllib.parse.quote(f"Opa, e aí, beleza? Passando aqui pra informar que está confirmado o/a {item['servico']} às {item['hora']}! Agradecemos sua preferência. Até mais 🤝🚀")
